    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                socket.on('new user', function (username) { return chat_1.newUser(socket, username); });
                socket.on('new message', function (msg) { return chat_1.newMessage(socket, msg); });
                _b = (_a = socket).emit;
                _c = ['connect to chat'];
                return [4 /*yield*/, chat_1.getAllMsgs()];
            case 1:
